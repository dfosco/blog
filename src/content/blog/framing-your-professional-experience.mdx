...
This article breaks a structured approach and exercise to **framing your professional experience**, and how I've used it to shape my written presentation when applying for jobs, including: improving the  my portfolio, resume, cover letter and LinkedIn profile. 
...
<post.mark color="gray" block>*Which companies or roles are more suited for your experience?*</post.mark>
<post.mark color="gray" block>*Which types of job openings do you see more of?*</post.mark>
<post.mark color="gray" block>*Which ones did you get a response from?*</post.mark>
<post.mark color="gray" block>*Where did you progress the furthest?*</post.mark>
<post.mark color="gray" block>*What indirect feedback did you gain from the interview process?*</post.mark>
...
<post.mark color="orange">Every job is a stepping stone if you keep aiming higher.</post.mark> 
...
Framing is an exercise to come up with a presentation strategy for yourself as a candidate, so you can <post.mark turn>highlight relevant work experiences and skills</post.mark> on each job you apply for. 

The goal of the exercise is to allow you to quickly adjust your presentation between each application, and prepare job assets that are focused and relevant, your portfolio, resume, LinkedIn, and even guide your responses during interviews. 

Framing can also be seen as your personal value proposition, or your <post.pop more="Positioning is a classic concept in advertising, and in many ways the foundation of modern marketing. Highly recommend digging into this if you're interested!">[positioning](https://en.wikipedia.org/wiki/Positioning_(marketing))</post.pop> as a candidate. 

Ultimately, your goal is to show companies you apply for <post.mark turn color="orange">how your background is relevant</post.mark>, <post.mark turn color="blue">why your skills are a match for the role</post.mark>, and <post.mark turn color="purple">what's the angle</post.mark> that makes you unique.
